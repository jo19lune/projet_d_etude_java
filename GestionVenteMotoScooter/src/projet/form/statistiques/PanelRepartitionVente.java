...
import projet.classes.statistiques.VenteParCategorie;

public class PanelRepartitionVente extends javax.swing.JPanel {

    public PanelRepartitionVente() {
        initComponents();
        setLayout(new BorderLayout());

        // Récupérer les statistiques SQL
        Map<String, Integer> ventes = VenteParCategorie.getVentesParCategorie();
        ...
        JFreeChart chart = ChartFactory.createPieChart(
                "Répartition des ventes par catégorie de véhicule",
                dataset,
